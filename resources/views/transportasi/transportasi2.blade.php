...
<br><br><br>
<div class="header">
Daftar Moda Transportasi yang Beroperasi di Jatim Mulai 10 Mei 2020
    <p style="opacity: 75%; font-size:15px; margin-left:3px">24-Juni-2022</p>
</div>

<div style="margin-left:55px; margin-bottom: 20px; margin-top:50px; color:white;">
    <img src="https://asset.kompas.com/crops/xsJuj60lMtTJkV4vcAMSkZ1Mllk=/0x0:1184x789/490x326/data/photo/2020/05/01/5eab1979bd594.jpg" width="500px">
        <br>
        Foto penutupan jalan oleh Polisi. (Photo by starline on Freepik)
</div>
<div class="container">
    <br>
...
<li>
                <div style="margin:35px;width:300px;background-color:white;border-radius:20px;padding:20px;text-align:left;color:black;text-decoration: none;box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25);">
                    <center>
                        <img src="https://www.suarasurabaya.net/wp-content/uploads/2018/12/kk213909_clip10.jpg" width="175px">
                        <h5>Pemkot Surabaya Belum Berencana Menambah Jam Operasional Suroboyo Bus</h5>
                    </center>
                ...
                <br>
                    ...
                    <a href="/category/transportasi/5" >
                        Baca Selengkapnya
                    </a>
                    </span>
                <br>
