...
<br><br><br>
<div class="header">
    25 Persen Ekonomi Jatim Berasal dari Surabaya, Ini Penyumbang PAD Terbesar
...
<div style="margin-left:55px; margin-bottom: 20px; margin-top:50px; color:white;">
    <img src="{{ asset('img/ekonomi7.jpg') }}" width="500px">
        <br>
        Warga membayar pajak kendaraanya pada mobil Samsat Keliling.
</div>
<div class="container">
    <br>
