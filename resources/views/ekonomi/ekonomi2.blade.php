...
<br><br><br>
<div class="header">
    Pertumbuhan Ekonomi Jatim Lebih Tinggi daripada Capaian Nasional
...
<div style="margin-left:40px; margin-bottom: 20px; margin-top:50px; color:white">
    <img src="{{ asset('img/ekonomi2.jpg') }}" width="500px" style="margin-left:3%;">
        <br>
        Gubernur Jawa Timur Khofifah Indar Parawansa. (Biro Administrasi Jatim)
</div>
<div class="container">
    <br>
