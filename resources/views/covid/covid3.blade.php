...
BOR COVID-19 Rendah, 3 RS Lapangan di Jatim Resmi Tak Beroperasi
    <p style="opacity: 75%; font-size:15px; margin-left:3px">4-July-2022</p>
</div>

<div style="margin-left:55px; margin-bottom: 20px; margin-top:50px; color:white;">
    <img src="https://akcdn.detik.net.id/community/media/visual/2021/09/14/rs-lapangan-indrapura-rsli-2_43.jpeg?w=700&q=90" width="500px">
        <br>
        RS Lapangan di Jawa Timur. (Photo by starline on Freepik)
</div>
<div class="container">
    <br>
