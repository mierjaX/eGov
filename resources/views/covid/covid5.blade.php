...
<br><br><br>
<div class="header">COVID-19 Kembali Merebak, Jatim Urutan ke-4 Terbanyak
    <p style="opacity: 75%; font-size:15px; margin-left:3px">15-Juni-2022</p>
</div>

<div style="margin-left:55px; margin-bottom: 20px; margin-top:50px; color:white;">
    <img src="https://akcdn.detik.net.id/community/media/visual/2021/12/28/jumlah-kasus-omicron-di-indonesia-ada-47-kasus-ini-3-faktanya_43.jpeg?w=700&q=90" width="500px">
        <br>
        Ilustrasi COVID-19 (Foto: BBC Magazine)
</div>
<div class="container">
    <br>
