...
<br><br><br>
<div class="header">Pamekasan Masih PPKM Level 3, Kenapa?
    <p style="opacity: 75%; font-size:15px; margin-left:3px">24-Mei-2022</p>
</div>

<div style="margin-left:55px; margin-bottom: 20px; margin-top:50px; color:white;">
    <img src="https://akcdn.detik.net.id/community/media/visual/2022/02/16/ppkm-jakarta-februari-2022_43.jpeg?w=700&q=90" width="500px">
        <br>
